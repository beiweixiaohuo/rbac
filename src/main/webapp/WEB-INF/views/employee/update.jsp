...
<body>
    <div class="modal-header">
        <span class="header">员工编辑</span>
        <button type="button" class="close" data-dismiss="modal" aria-label="close">
            <span >x</span>
        </button>
    </div>

        <form action="/employee/toUpdate.do" method="post">
            <div class="modal-body">
                <div class="row">
                    <div class="form-group col-md-4">
                        <label for="name" class="form-inline"><span class="red ">*</span>姓名:</label>
                        <input type="text" name="name" id="name" value="${empInfo.name}"  class="form-control" placeholder="员工姓名" >
                    </div>
                ...
                <div class="row">
                    <div class="form-group col-md-4">
                        <label for="nation"><span class="red">*</span>民族:</label>
                            <input type="text" name="nation" id="nation" value="${empInfo.nation}" class="form-control" placeholder="如：汉族" >
                    </div>

                    <div class="form-group col-md-4">
                        <label for="specialty"><span class="red">*</span>专业:</label>
                            <input type="text" name="specialty" id="specialty" value="${empInfo.specialty}" class="form-control" placeholder="请填写大学专业">
                ...
                <div class="row">
                    <div class="form-group col-md-4">
                        <label for="address"><span class="red">*</span>地址:</label>
                            <input type="text" name="address" id="address" value="${empInfo.address}" class="form-control" placeholder="请输入详细住址">

                    </div>

                    <div class="form-group col-md-4">
                        <label for="phone"><span class="red">*</span>号码:</label>
                            <input type="text" name="phone" id="phone" class="form-control" value="${empInfo.phone}" placeholder="请输入联系号码" aria-describedby="helpId">
                    ...
                    <div class="form-group col-md-4">
                        <label for="nativeplace"><span class="red">*</span>籍贯:</label>
                            <input type="text" name="nativeplace" id="nativeplace" value="${empInfo.nativeplace}" class="form-control" placeholder="请输入详细住址">
            ...
            <div class="row">
                ...
                <input type="text" name="school" id="school" value="${empInfo.school}" class="form-control" placeholder="请输入毕业院校">
                </div>

                <div class="form-group col-md-4.5">
                    <label for="idcard"><span class="red">*</span>身份证:</label>
                    <input type="text" name="idcard" id="idcard" value="${empInfo.idcard}" class="form-control" placeholder="请输入身份证号">
                </div>
                <div class="form-group col-md-4">
                    <label for="email"><span class="red">*</span>邮箱:</label>
                    <input type="text" name="email" id="email" value="${empInfo.email}" class="form-control" placeholder="例如：aa@163.com">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="date"class="form-control" name="begindate" value="<fmt:formatDate value="${empInfo.begindate}" pattern="yyyy-MM-dd"/>" >
                </div>

                <div class="form-group col-md-4">
                    <label for=""><span class="red">*</span>转正日期：</label>
                    <input type="date" class="form-control" name="conversiontime" value="<fmt:formatDate value="${empInfo.conversiontime}" pattern="yyyy-MM-dd"/>">
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="date" name="begincontract" value="<fmt:formatDate value="${empInfo.begincontract}" pattern="yyyy-MM-dd"/>"  class="form-control">
                </div>
                <div class="form-group col-md-6">
